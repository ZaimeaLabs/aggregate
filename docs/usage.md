...
github: https://github.com/zaimealabs/aggregate/edit/main/
---
...
To generate a aggregate for your model, import the `Zaimea\Aggregate\Aggregate` class and pass along a model or query.
`::model()` come as it is.
